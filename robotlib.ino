...
// extern long deltaDist; extern long newDist; extern long forwardDist;
...
void forward(float dist, float speed) {
  if (dist > 0)
    ...
    deltaDist = 9999999;  //if dist = 0, use a large number to continue moving forward indefinitely
